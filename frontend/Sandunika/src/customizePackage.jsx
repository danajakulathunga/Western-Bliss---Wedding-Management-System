...
function CustomizePackage() {
    ...
    const options = {
        ...
        music: [
            { label: "Live Band-News", price: 80000 },  // Fixed price from 800000
            { label: "DJ & Sound System-BDJ", price: 60000 },  // Fixed price from 600000
            { label: "DJ & Sound System-BDJ", price: 40000 },  // Fixed price from 400000
        ],
        decorations: [
        ...
        <div className="w-screen h-screen bg-pink-50 flex flex-col justify-center items-center p-10 overflow-auto">
            ...
            <div className="bg-white shadow-2xl rounded-xl p-8 w-full max-w-4xl border border-pink-200 relative">
                ...
                <div className="sticky bottom-0 left-0 w-full bg-white py-4 flex justify-center border-t border-pink-200 mt-6">
                    <button className="text-black    px-8 py-3 rounded-lg shadow-md text-lg font-bold hover:bg-pink-700 transition-all">
                        Book Custom Package
                    </button>
                </div>
            </div>
